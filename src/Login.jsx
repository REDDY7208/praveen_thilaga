...
const Login = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const apiUrl = isSignUp
      ? 'http://88.222.215.131:8081/register'
      : 'http://88.222.215.131:8081/login';
  ...
  const handleForgotPasswordSubmit = async (e) => {
    e.preventDefault();
    const apiUrl = 'http://88.222.215.131:8081/forgot_password';
  ...
  const handleOtpVerification = async (e) => {
    ...
    const apiUrl = 'http://88.222.215.131:8081/reset_password';
